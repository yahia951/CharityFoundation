        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('user_edit_profile_submit') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-3">
                                    @if (Auth::guard('web')->user()->photo != null)
                                        <img src="{{ asset('uploads/'.Auth::guard('web')->user()->photo) }}" alt="" class="profile-photo w_100_p">
                                    @else
